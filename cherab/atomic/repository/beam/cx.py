...
def add_beam_cx_rate(donor_ion, donor_metastable, receiver_ion, receiver_charge, transition, rate, repository_path=None):
    ...
    :param donor_metastable: Metastable level of beam neutral atom.
    ...
    :param rate: Beam CX PEC dictionary containing the following fields:
...
def update_beam_cx_rates(rates, repository_path=None):
    ...
    |      <donor_metastable> is the metastable level of beam neutral atom.
    ...
    |      <rate> is the beam CX PEC dictionary containing the following fields:
    |          'eb': array-like of size (N) with beam energy in eV/amu,
    |          'ti': array-like of size (M) with receiver ion temperature in eV,
    |          'ni': array-like of size (K) with receiver ion density in m^-3,
    |          'z': array-like of size (L) with receiver Z-effective,

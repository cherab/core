...
plasma = build_slab_plasma(width=0.01, peak_density=5e19, impurities=[(carbon, 6, 0.005)], world=world)
plasma.b_field = ConstantVector3D(Vector3D(0, 3.0, 0))
...
beam_full.models = [BeamEmissionLine(Line(deuterium, 0, (3, 2)))]
...
# beam_half.models = [BeamEmissionLine(Line(deuterium, 0, (3, 2)))]
...
# beam_third.models = [BeamEmissionLine(Line(deuterium, 0, (3, 2)))]
...
ray = Ray(origin=Point3D(1.25, -3.5, 0), direction=Vector3D(0, 1, 0), min_wavelength=640, max_wavelength=670, bins=2000)
s = ray.trace(world)
plt.figure()
